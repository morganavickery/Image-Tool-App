...
public class ImageEditorController
    implements ToolChoiceListener, MouseListener, MouseMotionListener {
  ...
  private BrushInspectorTool brush_inspector_tool;
  ...
  public ImageEditorController(ImageEditorView view, ImageEditorModel model) {
    ...
    brush_inspector_tool = new BrushInspectorTool(model);
  ...
  public void toolChosen(String tool_name) {
    ...
    } else if (tool_name.equals("Paint/Inspector")) {
      view.installToolUI(brush_inspector_tool.getUI());
      current_tool = brush_inspector_tool;
    }
  }
