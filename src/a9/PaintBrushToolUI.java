...
public class PaintBrushToolUI extends JPanel implements ChangeListener {
  ...
  public PaintBrushToolUI() {
    ...
    brush_size_panel.add(size_label, BorderLayout.WEST);
    size_slider = new JSlider(0, 10);
    size_slider.addChangeListener(this);
    brush_size_panel.add(size_slider, BorderLayout.CENTER);
  ...
  public void stateChanged(ChangeEvent e) {
    brushSize = size_slider.getValue();
    opacityValue = opacity_slider.getValue();

    p = new ColorPixel(red_slider.getValue() / 100.0, green_slider.getValue() / 100.0,
